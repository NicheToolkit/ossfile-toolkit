...
public class FileController {
    ...
    public ResponseEntity<OssfileBulkModel> fileUpload(@NonNull @RequestPart("file") MultipartFile file, OssfileRequest fileRequest) throws RestException {
        String originalFilename = file.getOriginalFilename();
        log.info("the file will be started uploading at 'fileUpload', filename: {}", originalFilename);
        OssfileBulkModel fileUpload = fileService.upload(file, fileRequest);
        return ResponseEntity.ok(fileUpload);
    }

    @PostMapping("/image/upload")
    public ResponseEntity<OssfileBulkModel> imageUpload(@NonNull @RequestPart("file") MultipartFile file, OssfileRequest fileRequest) throws RestException {
        String originalFilename = file.getOriginalFilename();
    ...
    public ResponseEntity<OssfileBulkModel> imageAutograph(@NonNull @RequestPart("file") MultipartFile file, OssfileRequest fileRequest) throws RestException {
        String originalFilename = file.getOriginalFilename();
    ...
    @Deprecated
    @PostMapping("/upload")
    public ResponseEntity upload(@NonNull @RequestPart("file") MultipartFile file, OssfileRequest fileRequest) throws RestException {
        String originalFilename = file.getOriginalFilename();
    ...
    public ResponseEntity filterRemove(OssfileFilter fileFilter) throws RestException {
