...
public enum OssfileErrorStatus implements RestStatus {
    ...
    /**
     * <code>OSSFILE_UPLOAD_SNOWBALL_OBJECT_ERROR</code>
     * {@link io.github.nichetoolkit.ossfile.OssfileErrorStatus} <p>The <code>OSSFILE_UPLOAD_SNOWBALL_OBJECT_ERROR</code> field.</p>
     */
    OSSFILE_UPLOAD_SNOWBALL_OBJECT_ERROR(11113, "The ossfile server has encountered an error with ossfile upload snowball object."),
    /**
