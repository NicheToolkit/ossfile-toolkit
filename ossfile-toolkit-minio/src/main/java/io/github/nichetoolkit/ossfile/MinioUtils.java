...
public class MinioUtils {
     ...
     * @param minioClient {@link io.github.nichetoolkit.ossfile.OssfileMinioClient} <p>The minio client parameter is <code>OssfileMinioClient</code> type.</p>
     ...
     */
    public static void initDefaultBucket(OssfileMinioClient minioClient, String bucketName) {
        try {
