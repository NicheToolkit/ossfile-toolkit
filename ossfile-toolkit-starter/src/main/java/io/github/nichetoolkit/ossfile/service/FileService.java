...
public interface FileService {
     ...
     */
    void remove(OssfileFilter fileFilter) throws RestException;
     ...
     * @throws RestException 服务异常
     */
    void download(OssfileBulkModel fileIndex, String filename, String contentType, Boolean preview, OssfileFileType fileType, HttpServletRequest request, HttpServletResponse response) throws RestException;
     ...
     * @throws RestException 服务异常
     */
    void download(OssfileBulkModel fileIndex, String filename, Boolean preview, OssfileFileType fileType, HttpServletRequest request, HttpServletResponse response) throws RestException;
     ...
     * @throws RestException 服务异常
     */
    void download(OssfileFilter fileFilter, HttpServletRequest request, HttpServletResponse response) throws RestException;
     ...
     * @throws RestException 服务异常
     */
    OssfileBulkModel upload(MultipartFile file, OssfileRequest fileRequest) throws RestException;
     ...
     * @throws RestException 服务异常
     */
    OssfileBulkModel upload(OssfileBulkModel fileIndex) throws RestException;
     ...
     * @throws RestException 服务异常
     */
    OssfileBulkModel indexUpload(OssfileBulkModel fileIndex) throws RestException;
     ...
     * @throws RestException 服务异常
     */
    OssfileBulkModel chunkUpload(MultipartFile file, String contentRange, OssfileRequest fileRequest) throws RestException;
