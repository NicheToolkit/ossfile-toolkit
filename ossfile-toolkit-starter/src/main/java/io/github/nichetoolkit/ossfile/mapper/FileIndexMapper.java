...
@Component
public interface FileIndexMapper extends RiceInfoMapper<OssfileBulkEntity>, Mapper<OssfileBulkEntity> {
    /**
     * 查询上传中断文件
     * @param name 文件源名称
     * @return T 查询的数据
     */
    OssfileBulkEntity findByNameWithUploadInterrupt(@Param("name") String name);
